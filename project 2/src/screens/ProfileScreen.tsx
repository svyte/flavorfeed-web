...
const ProfileScreen: React.FC = () => {
  ...
  const achievements = [
    ...
    { id: 2, name: 'Cuisine Explorer', icon: MapPin, color: 'text-american-gold' },
    { id: 3, name: 'Social Butterfly', icon: Heart, color: 'text-luxury-purple' },
          ...
          <Card>
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4">
              <div className="relative">
                ...
                />
                <button className="absolute -bottom-1 -right-1 w-8 h-8 bg-american-gold text-rich-black rounded-full flex items-center justify-center">
              ...
              <div className="flex-1 text-center sm:text-left">
                ...
                <p className="text-text-secondary font-inter mb-2">{user.email}</p>
                <div className="flex flex-col sm:flex-row items-center gap-2">
                  <Badge variant="gold">
                    <Crown className="w-3 h-3 mr-1" />
                    {user.membershipTier}
                  </Badge>
                  <span className="text-text-tertiary font-inter text-sm">Member since {user.memberSince}</span>
                </div>
              </div>
            </div>
          </Card>
        ...
        <div className="grid grid-cols-2 gap-4">
          <Card className="text-center">
            <div className="text-2xl sm:text-3xl font-playfair font-bold text-champagne-gold mb-1">
              {user.stats.restaurantsVisited}
            </div>
            <p className="text-text-secondary font-lato text-sm font-medium">Restaurants Visited</p>
          </Card>
          
          <Card className="text-center">
            <div className="text-2xl sm:text-3xl font-playfair font-bold text-royal-purple mb-1">
              {user.stats.cuisinesExplored}
            </div>
            <p className="text-text-secondary font-lato text-sm font-medium">Cuisines Explored</p>
          </Card>
          
          <Card className="text-center">
            <div className="text-2xl sm:text-3xl font-playfair font-bold text-social-blue mb-1">
              {user.stats.friendsConnected}
            </div>
          ...
          <Card className="text-center">
            ...
            <p className="text-text-secondary font-lato text-sm font-medium">Reviews Written</p>
          </Card>
        </div>
      </motion.div>
      ...
      >
        ...
        <Card className="bg-gradient-to-br from-champagne-gold/10 to-royal-purple/10 border-champagne-gold/30">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
            <div>
              <h3 className="font-crimson font-bold text-text-primary mb-1">Premium Member</h3>
              <p className="text-text-secondary font-inter text-sm">Enjoy exclusive benefits and experiences</p>
            </div>
