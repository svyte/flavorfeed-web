...
-- User favorites
CREATE INDEX CONCURRENTLY idx_user_favorites_user ON public.user_favorites (user_id, created_at DESC);
CREATE INDEX CONCURRENTLY idx_user_favorites_restaurant ON public.user_favorites (restaurant_id);
